...
def query_2(cumulated_table_name: str,daily_table_name: str,yesterday: str,today: str) -> str:
    query = f"""
...
def job_2 (spark_session: SparkSession,
    ...
    return spark_session.sql(query_2(cumulated_table_name,daily_table_name,yesterday,today))
