...
def test_job_2(spark_session):
    ...
    #     # Input data based on your provided values
    # Input_Web_Events = [
    #     Web_Events(2073894501, 36450401, "https://eczachly.substack.com/", "www.eczachly.com", "/signup", "2023-08-25 06:06:06.721 UTC"),
    #     Web_Events(542609727, 543560539, "https://www.linkedin.com/", "www.dataengineer.io", "/", "2023-08-25 05:59:56.406 UTC")
    # ]

    # Input_Devices = [
    #     Devices(36450401, "Chrome", "Windows", "Other"),
    #     Devices(543560539, "Mobile Safari UI/WKWebView", "iOS", "iPhone")
    # ]

    # Input_User_Device_Cumulated_yest = [
    #     User_Device_Cumulated(2092775577, "Other", [date(2023, 1, 1)], date(2023, 1, 1)),
    #     User_Device_Cumulated(2073894501, "Chrome", [date(2023, 1, 1)], date(2023, 1, 1))
    # ]

    # expected_output = [
    # User_Device_Cumulated(2092775577, "Other", [date(2023, 1, 1)], date(2023, 1, 1)),
    # User_Device_Cumulated(2073894501, "Chrome", [date(2023, 1, 1)], date(2023, 1, 1)),
    # User_Device_Cumulated(542609727, "Mobile Safari UI/WKWebView", [date(2023, 8, 25)], date(2023, 1, 1))
    # ]

    Input_Web_Events = [
        Web_Events(1078042172, 1088283544, "https://www.eczachly.com/blog/life-of-a-silicon-valley-big-data-engineer-3-critical-soft-skills-for-success", "www.eczachly.com", "/", "2023-01-01 00:03:24.519"),
        Web_Events(810784131, 532630305, None, "www.eczachly.com", "/contact", "2023-01-01 22:38:47.614")
    ]

    Input_Devices = [
        Devices(1088283544, "Other", "Other", "Other"),
        Devices(532630305, "PetalBot", "Android", "Generic Smartphone")
    ]

    Input_User_Device_Cumulated_yest = [
        User_Device_Cumulated(810784131, "PetalBot", [date(2022, 12, 31)], date(2023, 1, 1)),
        User_Device_Cumulated(1078042172, "Other", [], date(2023, 1, 1))
    ]

    expected_output = [
        User_Device_Cumulated(810784131, "PetalBot", [date(2023, 1, 1), date(2022, 12, 31)], date(2023, 1, 1)),
