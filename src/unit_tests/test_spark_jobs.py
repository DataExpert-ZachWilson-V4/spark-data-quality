...
def test_job_2(spark):
    ...
    # Web input
    web_input_data = [
        web_event(-838968542, -1259816303, "http://zachwilson.tech", "www.zachwilson.tech", "/", "2021-03-20 01:48:55.001 UTC"),
        web_event(972269998, -1259816303, "http://zachwilson.tech", "www.zachwilson.tech", "/contact", "2021-03-20 01:48:56.298 UTC"),
        web_event(972269998, -1259816303, "https://www.zachwilson.tech/contact", "www.zachwilson.tech", "/api/v1/contact", "2021-03-20 01:51:23.533 UTC"),
        web_event(-623801372, 532630305, None, "www.zachwilson.tech", "/api/v1/spark-post", "2021-03-20 01:51:37.091 UTC"),
        web_event(-1728795220, 464202459, None, "www.zachwilson.tech", "/", "2021-03-20 00:54:19.715 UTC"),
        web_event(-1728795220, 464202459, None, "www.zachwilson.tech", "/", "2021-03-20 00:54:21.596 UTC")
    ]
